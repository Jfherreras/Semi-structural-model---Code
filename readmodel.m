...
% Impact of the output gap on the real marginal
% MHCP - DGPM 19-01-2022
p.a33 = 0;
p.a33_4GM = 0.848;
p.bbetta  = 1;
...
%weight of oil/energy prices in the CPI basket
p.w_CPIE = 0.15;
...
%% A. The standard rule
% RS = g1*RS{-1} + (1-g1)*(RSNEUTRAL + g2*(D4L_CPI{+3} - D4L_CPI_TAR{+3}) + g3*L_GDP_GAP) + SHK_RS;
...
p.std_SHK_PREM        = std_SHK_PREM;%1; 
p.std_SHK_CR_PREM     = std_SHK_CR_PREM;%1; 
